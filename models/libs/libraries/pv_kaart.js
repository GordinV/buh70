module.exports = {
    selectAsLibs: `SELECT *
                   FROM
                       cur_pohivara l
                   WHERE
                       (l.rekvId = $1 OR l.rekvid IS NULL)`,
    select: [{
        sql: `SELECT
                  l.id,
                  l.rekvid,
        ...
        sql: `SELECT
              ...
              FROM
                  cur_pv_oper po
              WHERE
                  po.pv_kaart_id = $1`, //$1 doc_id, $2 userId
        multiple: true,
        alias: 'details',
        data: []
    },
        ...
        },
        {
            sql: `SELECT
                      ...
                      po.*
                  FROM
                      libs.get_pv_kaart_jaak($1::INTEGER) po`, //$1 doc_id, $2 userId
            multiple: false,
            alias: 'pv_jaak',
            data: []
        },
    ...
    executeCommand: {
        command: `SELECT *
                  FROM
                      sp_execute_task($1 :: INTEGER, $2 :: JSON, $3 :: TEXT)`, //$1- userId, $2 - params, $3 - task
        type: 'sql',
        alias: 'executeTask'
    },
};
