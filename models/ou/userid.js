module.exports = {
    ...
    select: [{
        sql: `SELECT
                  ...
                  coalesce((u.roles ->> 'is_eel_koostaja') :: BOOLEAN, FALSE)::boolean        AS is_eelkoostaja,
                  coalesce((u.roles ->> 'is_eel_allkirjastaja') :: BOOLEAN, FALSE)::boolean   AS is_eelallkirjastaja,
                  coalesce((u.roles ->> 'is_eel_esitaja') :: BOOLEAN, FALSE)::boolean         AS is_eelesitaja,
                  coalesce((u.roles ->> 'is_eel_aAktsepterja') :: BOOLEAN, FALSE)::boolean     AS is_eelaktsepterja,
                  coalesce((u.roles ->> 'is_asutuste_korraldaja') :: BOOLEAN, FALSE)::boolean AS is_asutuste_korraldaja,
                  coalesce((u.roles ->> 'is_rekl_administraator') :: BOOLEAN, FALSE)::boolean AS is_rekl_administrator,
        ...
        sqlAsNew: `SELECT
                      ...
                      FALSE :: BOOLEAN     AS is_eelkoostaja,
                      FALSE :: BOOLEAN     AS is_eelallkirjastaja,
                      FALSE :: BOOLEAN     AS is_eelesitaja,
                      FALSE :: BOOLEAN     AS is_eelaktsepterja,
