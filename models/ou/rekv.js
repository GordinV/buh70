    ...
    select: [{
    ...
    },
        {
            sql: `SELECT aa.id,
                         ...
                         kassa                                                     AS kassapank,
                         $2                                                        AS userId,
                         coalesce((aa.properties ->> 'kas_tulud')::BOOLEAN, FALSE) AS kas_tulud,
                         coalesce((aa.properties ->> 'kas_kulud')::BOOLEAN, FALSE) AS kas_kulud,
                         coalesce((aa.properties ->> 'kas_palk')::BOOLEAN, FALSE)  AS kas_palk
                  FROM ou.Aa aa
                  WHERE Aa.parentid = $1`,
            query: null,
            multiple: true,
