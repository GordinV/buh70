module.exports = {
    select: [{
        sql: `SELECT
                  ...
                  coalesce(p.palk_miinium, 886)::NUMERIC(14, 2)                                         AS palk_miinium,
        ...
        sqlAsNew: `SELECT
          ...
          85::NUMERIC(12, 2)                                                                          AS all_juht_osa`,
        query: null,
        multiple: false,
        alias: 'row',
        data: []
    ...
    deleteDoc: `SELECT
                    ...
                    error_message
                FROM
                    palk.sp_delete_palk_config($1, $2)`, // $1 - userId, $2 - docId
    grid: {
        gridConfiguration: [],
        sqlString: `SELECT *,
                           $2::INTEGER AS userId
