...
describe('dok. type Lisa 2 aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/eelarve_kofs'),
        docTypeId = 'EELARVE_KOFS'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/eelarve_kofs';
    ...
    it('doc type library should contain EELARVE_KOFS doc.type', async () => {
        let sql = `select id from libs.library where kood = 'EELARVE_KOFS' and  library = 'DOK' limit 1`;
