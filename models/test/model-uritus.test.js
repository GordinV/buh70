...
describe('dok. type Uuritus tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/uritus'),
        docTypeId = 'URITUS'.toLowerCase(),
        modelForExport = 'libs/libraries/uritus';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curUritused'})).toBeDefined();
    });
