...
describe('dok. type Hooleping tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../hooldekodu/hooleping'),
        docTypeId = 'HOOLEPING'.toLowerCase(),
        modelForExport = 'hooldekodu/hooleping';
...
/*
        ...
        expect(_.find(gridAlias.elements, {text: 'curHoolepingd'})).toBeDefined();
...
*/
    ...
    it('doc type library should contain HOOLEPING doc.type', async () => {
        let sql = `select id from libs.library where kood = 'HOOLEPING' and  library = 'DOK' limit 1`;
    ...
    it.skip('select as new query', async () => {
    ...
    it.skip('should exists proc sp_salvesta_luba', async () => {
    ...
    it.skip('should exists proc rekl.sp_muuda_lubastaatus', async () => {
    ...
    it.skip('should exists proc rekl.sp_recalc_rekl_jaak', async () => {
    ...
    it.skip('should exists proc rekl.sp_koosta_pikendus', async () => {
    ...
    it.skip('should exists proc rekl.sp_calc_dekl', async () => {
    ...
    it.skip('should exists proc rekl.sp_calc_intress', async () => {
    ...
    it.skip('should exists operation in libs', async () => {
    ...
    it.skip('should exists proc rekl.sp_koosta_parandus', async () => {
    ...
    it.skip('should exists proc rekl.sp_luba_annuleri', async () => {
    ...
    it.skip('should exists proc sp_delete_luba', async () => {
