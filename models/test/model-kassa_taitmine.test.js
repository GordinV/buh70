...
describe('dok. type Eelarve kassa täitmine aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/kassa_taitmine'),
        docTypeId = 'LISA_2'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/kassa_taitmine';
    ...
    it('doc type library should contain KASSA_TAITMINE doc.type', async () => {
