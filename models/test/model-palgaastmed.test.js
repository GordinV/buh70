...
describe('dok. type PALGAASTMED tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/ameti_klassif'),
        docTypeId = 'PALGAASTMED'.toLowerCase(),
        modelForExport = 'libs/libraries/palgaastmed';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curPalgaastmed'})).toBeDefined();
    });
