...
describe('dok. type Eelarve tulude allikas ja artikkel täitmine aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/tulud_allikas_artikkel'),
        docTypeId = 'TULUD_ALLIKAS_ART'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/tulud_allikas_artikkel';
    ...
    it('doc type library should contain TULUD_ALL_ART doc.type', async () => {
