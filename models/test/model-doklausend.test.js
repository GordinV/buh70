...
describe('dok. type Doklausend tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../raamatupidamine/doklausend'),
        docTypeId = 'DOKLAUSEND'.toLowerCase(),
        modelForExport = 'raamatupidamine/doklausend';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curDoklausend'})).toBeDefined();
    });
