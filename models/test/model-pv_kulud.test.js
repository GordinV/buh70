...
describe('dok. type pv_kulud tests', function () {
    ...
    const doc = require('../aruanned/raamatupidamine/pv_kulud'),
        docTypeId = 'PV_KULUD'.toLowerCase(),
        modelForExport = 'aruanned/raamatupidamine/pv_kulud';
    ...
    it.skip('doc type library should contain PV_KULUD doc.type', async () => {
        let sql = `select id from libs.library where kood = 'PV_KULUD' and  library = 'DOK' limit 1`;
