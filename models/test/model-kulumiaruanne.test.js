...
describe('dok. type kulumiaruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/pv/kulumiaruanne'),
        docTypeId = 'KULUMIARUANNE'.toLowerCase(),
        modelForExport = 'aruanned/pv/kulumiaruanne';
    ...
    it('doc type library should contain KULUMIARUANNE doc.type', async () => {
        let sql = `select id from libs.library where kood = 'KULUMIARUANNE' and  library = 'DOK' limit 1`;
