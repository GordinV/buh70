...
describe('dok. type Puudumine tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../palk/puudumine'),
        docTypeId = 'PUUDUMINE'.toLowerCase(),
        modelForExport = 'palk/puudumine';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curPuudumine'})).toBeDefined();
    });
