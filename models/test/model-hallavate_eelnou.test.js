...
describe('dok. type Hallavate asutuse kondeelarve eelnou tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/hallavate_eelnou'),
        docTypeId = 'HALLAVATE_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/hallavate_eelnou';
    ...
    it('doc type library should contain HALLAVATE_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'HALLAVATE_EELNOU' and  library = 'DOK' limit 1`;
