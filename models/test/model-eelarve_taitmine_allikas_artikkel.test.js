...
describe('dok. type Eelarve allikas ja artikkel täitmine aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/taitmine_allikas_artikkel'),
        docTypeId = 'TAITMINE_ALLIKAS_ART'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/taitmine_allikas_artikkel';
