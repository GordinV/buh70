...
describe('dok. type Eelarve täitmine jääk aruanne tests', function () {
    ...
    const doc = require('../aruanned/eelarve/taitmine_jaak'),
        docTypeId = 'TAITMINE_JAAK'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/taitmine_jaak';
    ...
    it.skip('doc type library should contain TAITMINE_JAAK doc.type', async () => {
        let sql = `select id from libs.library where kood = 'TAITMINE_JAAK' and  library = 'DOK' limit 1`;
