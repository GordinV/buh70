...
describe('dok. type KULUD_EELNOU_DETAILNE tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/kulud_eelnou_detailne'),
        docTypeId = 'KULUD_EELNOU_DETAILNE'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/kulud_eelnou_detailne';
    ...
    it.skip('doc type library should contain KULUD_EELNOU_DETAILNE doc.type', async () => {
        let sql = `select id from libs.library where kood = 'KULUD_EELNOU_DETAILNE' and  library = 'DOK' limit 1`;
    ...
    it.skip('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2021-12-31',63, 1]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
