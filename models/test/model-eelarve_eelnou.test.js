...
describe('dok. type Eelarve eelnou tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/eelarve_eelnou'),
        docTypeId = 'EELARVE_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/eelarve_eelnou';
    ...
    it('doc type library should contain EELARVE_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'EELARVE_EELNOU' and  library = 'DOK' limit 1`;
