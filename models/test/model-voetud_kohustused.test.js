...
describe('dok. type Voestud kohustused tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/voetud_kohustused'),
        docTypeId = 'VOETUD_KOHUSTUSED'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/voetud_kohustused';
    ...
    it.skip('doc type library should contain VOETUS_KOHUSTUSED doc.type', async () => {
        let sql = `select id from libs.library where kood = 'VOETUS_KOHUSTUSED' and  library = 'DOK' limit 1`;
