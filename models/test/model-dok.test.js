...
describe('dok. type DOK tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/dok'),
        docTypeId = 'DOK'.toLowerCase(),
        modelForExport = 'libs/libraries/dok';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curDok'})).toBeDefined();
    });
