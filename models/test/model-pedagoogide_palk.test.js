...
describe('dok. type pedagoogide_palk tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/palk/pedagoogide_palk'),
        docTypeId = 'PEDAGOOGIDE_PALK'.toLowerCase(),
        modelForExport = 'aruanned/palk/pedagoogide_palk';
