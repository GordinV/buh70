...
describe('dok. type Rahavoog aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/rahavoog_aruanne'),
        docTypeId = 'RAHAVOOG_ARUANNE'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/rahavoog_aruanne';
