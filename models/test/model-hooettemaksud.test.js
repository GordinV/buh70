...
describe('dok. type HOOETTEMAKSUD tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../hooldekodu/hooettemaksud'),
        docTypeId = 'HOOETTEMAKSUD'.toLowerCase(),
        modelForExport = 'hooldekodu/hooettemaksud';
