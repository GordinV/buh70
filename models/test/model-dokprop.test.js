...
describe('dok. type Dokprop tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/dokprops'),
        docTypeId = 'DOKPROPS'.toLowerCase(),
        modelForExport = 'libs/libraries/dokprops';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curDokprop'})).toBeDefined();
    });
