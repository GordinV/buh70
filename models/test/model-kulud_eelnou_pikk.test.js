...
describe('dok. type KULUD_EELNOU_PIKK tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/kulud_eelnou_pikk'),
        docTypeId = 'KULUD_EELNOU_PIKK'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/kulud_eelnou_pikk';
    ...
    it.skip('doc type library should contain KULUD_EELNOU_PIKK doc.type', async () => {
        let sql = `select id from libs.library where kood = 'KULUD_EELNOU_PIKK' and  library = 'DOK' limit 1`;
