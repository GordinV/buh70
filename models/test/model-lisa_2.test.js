...
describe('dok. type Lisa 2 aruanne tests', function () {
    ...
    const doc = require('../aruanned/eelarve/lisa_2'),
        docTypeId = 'LISA_2'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/lisa_2';
    ...
    it('doc type library should contain LISA_2 doc.type', async () => {
        let sql = `select id from libs.library where kood = 'LISA_2' and  library = 'DOK' limit 1`;
