...
describe('dok. type LISA1_LISA5_KONTROL_asutuste_jargi tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/lisa1_lisa5_kontrol_asutuste_jargi'),
        docTypeId = 'LISA1_LISA5_KONTROL'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/lisa1_lisa5_kontrol_asutuste_jargi';
    ...
    it('should have copy in buh62 folder', (done) => {
        ...
        console.log('sourceFile',sourceFile,copyFile);
    ...
    it.skip('doc type library should contain LISA1_LISA5_KONTROL doc.type', async () => {
        let sql = `select id from libs.library where kood = 'LISA1_LISA5_KONTROL' and  library = 'DOK' limit 1`;
    ...
    it.skip('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2021-03-31',63, 1]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
