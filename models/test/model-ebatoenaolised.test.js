...
describe('dok. type kond ebatoenaolised aruanned tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/raamatupidamine/kond_ebatoenaolised'),
        docTypeId = 'KOND_EBATOENAOLISED'.toLowerCase(),
        modelForExport = 'aruanned/raamatupidamine/kond_ebatoenaolised';
    ...
    it.skip('doc type library should contain ALLIKAS_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'ALLIKAS_EELNOU' and  library = 'DOK' limit 1`;
    ...
    it.skip('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2019-12-31',63, 1]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
