...
describe('dok. type Taotlus tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../eelarve/taotlus'),
        docTypeId = 'TAOTLUS'.toLowerCase(),
        modelForExport = 'eelarve/taotlus';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curTaotlus'})).toBeDefined();
