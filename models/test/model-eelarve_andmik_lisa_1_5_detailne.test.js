...
describe('dok. type Eelarve andmik lisa 1 - 5 detailne aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/eelarve_andmik_lisa_1_5_detailne'),
        docTypeId = 'EELARVE_ANDMIK_LISA_1_5_detailne'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/eelarve_andmik_lisa_1_5_detailne';
    ...
    it.skip('doc type library should contain EELARVE_LISA_1_5 doc.type', async () => {
        let sql = `select id from libs.library where kood = 'EELARVE_LISA_1_5' and  library = 'DOK' limit 1`;
    ...
    it('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2018-12-31',63, 0]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
