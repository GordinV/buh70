...
describe('dok. type Eelarve täitmine (A,TT,Tunnus,Art,Projekt,Üritus) aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/eelarve_taitmine_art_ta_allikas_proj_tunnus'),
        docTypeId = 'TAITMINE_ART_TA_A_P'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/eelarve_taitmine_art_ta_allikas_proj_tunnus';
    ...
    it.skip('doc type library should contain KASSA_TAITMINE doc.type', async () => {
        let sql = `select id from libs.library where kood = 'KASSA_TAITMINE' and  library = 'DOK' limit 1`;
