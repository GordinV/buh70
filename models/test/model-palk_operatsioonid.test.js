...
describe('dok. type Palk_operatsioonid tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/palk/palk_operatsioonid'),
        docTypeId = 'PALK_OPERATSIOONID'.toLowerCase(),
        modelForExport = 'aruanned/palk/palk_operatsioonid';
    ...
    it('doc type library should contain PALK_OPERATSIOONID doc.type', async () => {
        let sql = `select id from libs.library where kood = 'PALK_OPERATSIOONID' and  library = 'DOK' limit 1`;
    ...
    it('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2018-01-01','2018-12-31', 1]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
