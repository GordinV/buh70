...
describe('dok. type Kontod tests', function () {
    ...
    const doc = require('../libs/libraries/kontod'),
        docTypeId = 'KONTOD'.toLowerCase(),
        modelForExport = 'libs/libraries/kontod';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curKontod'})).toBeDefined();
    });
