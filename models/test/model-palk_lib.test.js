...
describe('dok. type PalkLib tests', function () {
    ...
    it('should exists view com_palk_lib', async()=> {
        let sql = `select 1 FROM pg_views WHERE viewname = 'com_palk_lib'`;
    ...
    it('should return data from  view com_palk_lib', async()=> {
        let sql = `select * from palk.com_palk_lib`;
        let returnValue = await db.queryDb(sql, []);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
        expect(result).toBeGreaterThan(0);
    ...
    it('should exists data type palk_liik', async()=> {
        let sql = `select enum_range(NULL :: PALK_LIIK)::text as result`;
        let returnValue = await db.queryDb(sql, []);
        expect(returnValue).toBeDefined();
        let result = returnValue.data[0].result;
