...
describe('dok. type LISA1_LISA5_KONTROL tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/lisa1_lisa5_kontrol'),
        docTypeId = 'LISA1_LISA5_KONTROL'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/lisa1_lisa5_kontrol';
