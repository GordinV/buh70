...
describe('dok. type KuludeTaitmine tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../eelarve/kulude_taitmine'),
        docTypeId = 'TULUDE_TAITMINE'.toLowerCase(),
        modelForExport = 'eelarve/kulude_taitmine';
