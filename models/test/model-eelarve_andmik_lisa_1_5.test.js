...
describe('dok. type Eelarve andmik lisa 1/ lisa 5 aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/eelarve_andmik_lisa_1_5'),
        docTypeId = 'EELARVE_ANDMIK_LISA_1_5'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/eelarve_andmik_lisa_1_5';
    ...
    it('doc type library should contain EELARVE_LISA_1_5 doc.type', async () => {
