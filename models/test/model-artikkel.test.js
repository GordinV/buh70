...
describe('dok. type Artikkel tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/artikkel'),
        docTypeId = 'ARTIKKEL'.toLowerCase(),
        modelForExport = 'libs/libraries/artikkel';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curTuludeAllikad'})).toBeDefined();
    });
