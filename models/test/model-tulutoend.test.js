...
describe('dok. type Tulutoend aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/tulutoend'),
        docTypeId = 'TULUTOEND'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/tulutoend';
    ...
    it('doc type library should contain TULUTOEND doc.type', async () => {
        let sql = `select id from libs.library where kood = 'TULUTOEND' and  library = 'DOK' limit 1`;
    ...
    it.skip('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2021-01-01','2021-01-31', 63]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
