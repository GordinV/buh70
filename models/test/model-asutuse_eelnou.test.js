...
describe('dok. type Asutuse kondeelarve eelnou tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/asutuse_eelnou'),
        docTypeId = 'ASUTUSE_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/asutuse_eelnou';
    ...
    it('doc type library should contain ASUTUSE_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'ASUTUSE_EELNOU' and  library = 'DOK' limit 1`;
