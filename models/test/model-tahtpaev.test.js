...
describe('dok. type Tahtpaev tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/tahtpaev'),
        docTypeId = 'TAHTPAEV'.toLowerCase(),
        modelForExport = 'libs/libraries/tahtpaev';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curHoliday'})).toBeDefined();
    });
