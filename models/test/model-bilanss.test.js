...
describe('dok. type Bilanss aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/bilanss'),
        docTypeId = 'BILANSS'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/bilanss';
    ...
    it.skip('doc type library should contain BILANSS doc.type', async () => {
        let sql = `select id from libs.library where kood = 'BILANSS' and  library = 'DOK' limit 1`;
    ...
    it.skip('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['2021-03-31',63,0]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
