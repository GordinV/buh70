...
describe('dok. type mitte_saadetud_lehed tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/ou/mitte_saadetud_lehed'),
        docTypeId = 'mitte_saadetud_lehed'.toLowerCase(),
        modelForExport = 'aruanned/ou/mitte_saadetud_lehed';
