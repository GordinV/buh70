...
describe('dok. type Hoo kaibeandmik tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/hooldekodu/hoo_kaibeandmik'),
        docTypeId = 'EELARVE_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/hooldekodu/hoo_kaibeandmik';
    ...
    it('doc type library should contain HOO_KAIBEANDMIK doc.type', async () => {
        let sql = `select id from libs.library where kood = 'HOO_KAIBEANDMIK' and  library = 'DOK' limit 1`;
