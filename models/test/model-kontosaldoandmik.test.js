...
describe('dok. type kontoasutusandmik tests', function () {
    ...
    const doc = require('../aruanned/raamatupidamine/kontosaldoandmik'),
        docTypeId = 'KONTOSALDOANDMIK'.toLowerCase(),
        modelForExport = 'aruanned/raamatupidamine/kontosaldoandmik';
    ...
    it('should select data from grid query', async()=> {
        ...
        let returnValue = await db.queryDb(sql, ['113',null,'2018-08-31', 1]);
        expect(returnValue).toBeDefined();
        let result = returnValue.result;
