...
describe('dok. type PV kaiba_aruanne tests', function () {
    ...
    const doc = require('../aruanned/pv/oiend'),
        docTypeId = 'OIEND'.toLowerCase(),
        modelForExport = 'aruanned/pv/oiend';
    ...
    it('doc type library should contain OIEND doc.type', async () => {
        let sql = `select id from libs.library where kood = 'OIEND' and  library = 'DOK' limit 1`;
