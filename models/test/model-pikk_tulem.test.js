...
describe('dok. type Pikk Tulem aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/pikk_tulem'),
        docTypeId = 'PIKK_TULEM'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/pikk_tulem';
    ...
    it('doc type library should contain PIKK_TULEM doc.type', async () => {
        let sql = `select id from libs.library where kood = 'PIKK_TULEM' and  library = 'DOK' limit 1`;
