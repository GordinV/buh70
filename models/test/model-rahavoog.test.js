...
describe('dok. type Rahavoog tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/rahavoog'),
        docTypeId = 'RAHAVOOG'.toLowerCase(),
        modelForExport = 'libs/libraries/rahavoog';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curRaha'})).toBeDefined();
    });
