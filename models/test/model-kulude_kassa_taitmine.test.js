...
describe('dok. type KuludeKassaTaitmine tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../eelarve/kulude_kassa_taitmine'),
        docTypeId = 'TULUDE_KASSA_TAITMINE'.toLowerCase(),
        modelForExport = 'eelarve/kulude_kassa_taitmine';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curKuluTaitm'})).toBeDefined();
    });
