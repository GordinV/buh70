...
describe('dok. type Allikas tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/allikas'),
        docTypeId = 'ALLIKAS'.toLowerCase(),
        modelForExport = 'libs/libraries/allikas';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curAllikad'})).toBeDefined();
    });
