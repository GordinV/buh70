...
describe('dok. type TuludeKassaTaitmine tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../eelarve/tulude_kassa_taitmine'),
        docTypeId = 'TULUDE_KASSA_TAITMINE'.toLowerCase(),
        modelForExport = 'eelarve/tulude_kassa_taitmine';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curTuluTaitm'})).toBeDefined();
    });
