...
describe('dok. type Nomenclature tests', function () {
    ...
    const doc = require('../libs/libraries/nomenclature'),
        docTypeId = 'NOMENCLATURE'.toLowerCase(),
        modelForExport = 'libs/libraries/nomenclature';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curNomenklatuur'})).toBeDefined();
    });
