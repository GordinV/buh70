...
describe('dok. type TP tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/tp'),
        docTypeId = 'TP'.toLowerCase(),
        modelForExport = 'libs/libraries/tp';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curTPR'})).toBeDefined();
    });
