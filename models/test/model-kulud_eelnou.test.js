...
describe('dok. type KULUD_EELNOU tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/kulud_eelnou'),
        docTypeId = 'KULUD_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/kulud_eelnou';
    ...
    it.skip('doc type library should contain KULUD_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'KULUD_EELNOU' and  library = 'DOK' limit 1`;
