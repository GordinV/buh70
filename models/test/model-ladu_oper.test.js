...
describe('dok. type Ladu Oper tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/ladu_oper'),
        docTypeId = 'LADU_OPER'.toLowerCase(),
        modelForExport = 'libs/libraries/ladu_oper';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curLaduOper'})).toBeDefined();
    });
