...
describe('dok. type Hallavate asutuse kondeelarve eelnou allikate loikes tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/allikas_eelnou'),
        docTypeId = 'ALLIKAS_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/allikas_eelnou';
    ...
    it('doc type library should contain ALLIKAS_EELNOU doc.type', async () => {
