...
describe('dok. type Pikk Tulem aruanne tests', function () {
    ...
    const doc = require('../aruanned/eelarve/tulem'),
        docTypeId = 'PIKK_TULEM'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/tulem';
    ...
    it.skip('doc type library should contain TULEM doc.type', async () => {
        let sql = `select id from libs.library where kood = 'TULEM' and  library = 'DOK' limit 1`;
