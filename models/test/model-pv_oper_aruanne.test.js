...
describe('dok. type pv_oper_aruanne tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/pv/pv_oper_aruanne'),
        docTypeId = 'PV_OPER_ARUANNE'.toLowerCase(),
        modelForExport = 'aruanned/pv/pv_oper_aruanne';
    ...
    it('doc type library should contain PV_OPER_ARUANNE doc.type', async () => {
        let sql = `select id from libs.library where kood = 'PV_OPER_ARUANNE' and  library = 'DOK' limit 1`;
