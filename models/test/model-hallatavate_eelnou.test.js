...
describe('dok. type HALLATAVATE_EELNOU tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/hallatavate_eelnou'),
        docTypeId = 'HALLATAVATE_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/hallatavate_eelnou';
    ...
    it.skip('doc type library should contain HALLATAVATE_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'HALLATAVATE_EELNOU' and  library = 'DOK' limit 1`;
