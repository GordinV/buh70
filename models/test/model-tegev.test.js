...
describe('dok. type Tegev tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../libs/libraries/tegev'),
        docTypeId = 'TEGEV'.toLowerCase(),
        modelForExport = 'libs/libraries/tegev';
    ...
    it (`${docTypeId} must have fields in xml model`,() => {
        ...
        expect(_.find(gridAlias.elements,{text:'curTegev'})).toBeDefined();
    });
