...
describe('dok. type Hallavate asutuse kondeelarve eelnou tegevusalla loikes tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../aruanned/eelarve/tegev_eelnou'),
        docTypeId = 'TEGEV_EELNOU'.toLowerCase(),
        modelForExport = 'aruanned/eelarve/tegev_eelnou';
    ...
    it('doc type library should contain TEGEV_EELNOU doc.type', async () => {
        let sql = `select id from libs.library where kood = 'TEGEV_EELNOU' and  library = 'DOK' limit 1`;
