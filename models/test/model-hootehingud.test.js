...
describe('dok. type HOOTEHINGUD tests', function () {
    let globalDocId = 0; // для сохранения ид документа

    const doc = require('../hooldekodu/hootehingud'),
        docTypeId = 'HOOTEHINGUD'.toLowerCase(),
        modelForExport = 'hooldekodu/hootehingud';
