module.exports = {
    grid: {
        gridConfiguration: [
            ...
            {id: "kpv", name: "Arve kuupäev", width: "10%", type: "date"},
            ...
            {id: "earved", name: "Saadetud e-arvega", width: "10%"},
        ...
        sqlString: `SELECT a.number,
                           ...
                           c.email                                                        AS saaja_email,
                           to_char(log.email, 'DD.MM.YYYY HH:MI:SS')                      AS email,
                           to_char(log.earve, 'DD.MM.YYYY HH:MI:SS')                      AS earve,
                           to_char(log.print, 'DD.MM.YYYY HH:MI:SS')                      AS print,
                           r.nimetus                                                      AS asutus,
                           $2                                                             AS user_id
