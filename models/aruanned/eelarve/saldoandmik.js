                                 ...
                                 (SELECT l.kood,
                                  ...
                                  qrySaldoAndmik AS (
                                      ...
                                      WHERE d.rekvid IN (SELECT rekv_id
                                        ...
                                        AND d.rekvid =
                                            CASE WHEN $3::INTEGER IS NULL THEN $2::INTEGER ELSE d.rekvid END
                                        AND j.kpv <= $1::DATE
                                        AND (($4::JSONB ->> 'tunnus') IS NULL OR
                                             coalesce(j1.tunnus, '') ILIKE
                                             coalesce(($4::JSONB ->> 'tunnus'), '') || '%')
                                        AND (($4::JSONB ->> 'proj') IS NULL OR
                                             coalesce(j1.proj, '') ILIKE
                                             coalesce(($4::JSONB ->> 'proj'), '') || '%')
                                        AND d.status <> 3
                                      UNION ALL
                                      ...
                                      WHERE d.rekvid IN (SELECT rekv_id
                                        ...
                                        AND (($4::JSONB ->> 'proj') IS NULL OR
                                             ...
                                             coalesce(($4::JSONB ->> 'proj'), '') || '%')
                                        AND d.status <> 3
                                      GROUP BY coalesce(a.kpv, j.kpv), j.kpv, j.rekvid, j1.kreedit,
                                               j1.lisa_k, j1.kood1,
                                               j1.kood2, j1.kood3
                                  )
                             SELECT rekv_id,
                                      ...
                                      SELECT qry.rekvid                  AS rekv_id,
                                             ...
                                             (CASE
                                                  WHEN l.is_tp AND left(konto, 6) IN ('150200', '150210', '150020') AND
                                                       ltrim(rtrim(coalesce(rahavoog, ''))) IN ('01', '00', '17', '21')
                                                      THEN tp
                                                  WHEN l.is_tp AND
                                             ...
                                             (CASE
                                                  WHEN is_tegev AND
                                                       ...
                                                       ltrim(rtrim(COALESCE(CASE
                                                                                WHEN qry.kpv < make_date(year($1::DATE), 1, 1)
                                                                                    THEN '00'
                                      ...
                                      SELECT rekvid                     AS rekv_id,
                                             ...
                                             (CASE
                                                  WHEN is_tp AND (ltrim(rtrim(COALESCE(l.muud, ''))) <> '*' OR
                                                                  ltrim(rtrim(qry.rahavoog)) IN ('01', '00', '21', '17'))
                                                      THEN tp
                                                  ELSE
                                                      '' END)::CHAR(20) AS tp,
                                             (CASE
