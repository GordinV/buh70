module.exports = {
    grid: {
        ...
        sqlString: `WITH report AS (
                ...
                FROM eelarve.kulud_eelnou_detailne($1::DATE, $2::INTEGER, $3::INTEGER, $4::jsonb) qryReport
                WHERE artikkel <> ''
            ),
                     qryKond AS (
                         SELECT 
            ...
            CASE WHEN tegev = '01-10' then '0' ELSE qryReport.tegev END, qryReport.tunnus, qryReport.proj, qryReport.uritus, qryReport.artikkel`,     // $1 - kpv $2 - rekvid, $3 - kond
        params: '',
        alias: 'kulud_eelnou'
    }
};
