...
exports.post = async (req, res) => {
    ...
    const taskName = 'importAsendusTaabel';
    ...
    console.log('task importAsendusTaabel',execDate );
    ...
    let lastDocId = 1;
    try {
        tulemused = await doc.executeTask(taskName, [user.userId, user.asutusId, execDate]);
    } catch (e) {
