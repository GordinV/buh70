...
BEGIN
    ...
    INSERT INTO ou.session_uuid (userid, asutusid, uuid, user_data, users)
    VALUES (l_userId, l_asutusId, l_uuid, l_user_data, l_users) RETURNING id
        INTO l_id;
    RETURN l_id;
