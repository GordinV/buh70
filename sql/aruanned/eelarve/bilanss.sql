...
FROM (
         SELECT rekv_id,
                ...
                nimetus,
                summa                                         AS summa,
                eelmise_summa                                 AS eelmise_summa,
                CASE
                    -- '`*'
         ...
         FROM (
                  ...
                  SELECT l_rekvid,
                         ...
                         'Netovara'                                                  AS nimetus,
                         0                                                           AS summa,
                         sum(coalesce(kr, 0)) - sum(coalesce(db, 0))::NUMERIC(14, 2) AS eelmise_summa,
                         200                                                         AS idx
                  FROM qryEelmiseNettovara
              ) qry
         UNION ALL
         SELECT *
         FROM (
