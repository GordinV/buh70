     ...
     qryReport AS (
         ...
         FROM (
                  ...
                  FROM (
                           ...
                           FROM cur_kulude_taitmine ft
                           WHERE ((ft.artikkel LIKE
                                   '4%' OR ft.artikkel LIKE
                                           '5%' OR
                                   (ft.artikkel LIKE
                                    '6%' AND ft.artikkel NOT LIKE
                                             '655%') OR
                                   ft.artikkel LIKE
                                   '15%'))
                           UNION ALL
...
--             OR (left(j.deebet, 6) IN ('203620', '203630'))
                  ...
                  WHERE rekvid = (CASE
                    ...
                    AND (kood5 LIKE '4%'
                      OR kood5 LIKE '5%'
                      OR (kood5 LIKE '6%' AND kood5 NOT LIKE '655%')
                      OR kood5 LIKE '15%'
                      OR kood5 = '2586'
                      )
                  GROUP BY e.rekvid
                  ...
                  WHERE rekvid = (CASE
                    ...
                    AND e.rekvid IN
                        (SELECT rekv_id
                         FROM get_asutuse_struktuur(l_rekvid))
                    AND aasta = l_aasta
                    AND (kood5 LIKE '4%' OR kood5 LIKE '5%'
                      OR (kood5 LIKE '6%' AND kood5 NOT LIKE '655%')
                      OR kood5 LIKE '15%'
                      OR kood5 = '2586'
                      )
