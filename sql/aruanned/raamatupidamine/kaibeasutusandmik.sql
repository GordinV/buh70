...
WITH
    ...
    report AS (
                  SELECT
                      ...
                      max(qry.viimane_tehing) as viimane_tehing,
                  ...
                  FROM
                      (
                          ...
                          WHERE
                            ...
                            and (p.laps_id is null or d.id in (
                                                                  select docid
                                                                  from lapsed
                                                              ))
                          UNION ALL
...
SELECT
    ...
    999999                AS rekv_id,
    r.laps_id,
    max(r.viimane_tehing) as viimane_tehing
FROM
    report r
WHERE
    l_kond > 0
GROUP BY
    r.konto, r.asutus_id, r.laps_id;
