  ...
  FOR v_orderid IN
    WITH algsaldo AS (
      ...
      FROM (
             SELECT rekvid,
                    ...
                    $1 - 1                             AS kpv,
                    'Alg. saldo'                       AS alus,
                    algsaldo.alg_saldo::NUMERIC(14, 2) AS deebet,
             ...
             FROM docs.doc d
                    ...
                    INNER JOIN docs.korder2 k2 ON k2.parentid = k.id
    ...
    LOOP
      ...
      THEN
        ...
        THEN
          UPDATE temp_kassaraamat_table SET lopp_paevi_saldo = l_alg_saldo WHERE temp_kassaraamat_table.kassa = l_kassa AND temp_kassaraamat_table.kpv = l_kpv;
        END IF;
      ...
      INSERT INTO temp_kassaraamat_table (rekv_id, kassa, kpv, alus, alg_saldo, alg_paevi_saldo, deebet, kreedit, lopp_saldo, number,
      ...
      VALUES (v_orderid.rekvid,
              ...
              v_orderid.deebet,
              v_orderid.kreedit,
              (l_alg_saldo + v_orderid.deebet - v_orderid.kreedit),
              v_orderid.number,
              v_orderid.isik,
              v_orderid.konto,
              v_orderid.kood1,
      ...
      -- сохраним сальдо
      l_alg_saldo = l_alg_saldo + v_orderid.deebet - v_orderid.kreedit;
