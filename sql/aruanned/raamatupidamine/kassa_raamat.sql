...
BEGIN
    ...
    FOR v_orderid IN
        WITH algsaldo AS (
            SELECT sum(qry.deebet) - sum(qry.kreedit) AS alg_saldo,
                   qry.kassaid,
                   qry.rekvid
            FROM (
                     SELECT d.rekvid,
        ...
        FROM (
                 ...
                 FROM docs.doc d
                          ...
                          INNER JOIN(SELECT sum(k2.summa)                                                       AS summa,
                                            k2.konto,
        ...
        LOOP
            ...
            THEN
                ...
                THEN
                    ...
                    SET lopp_paevi_saldo = l_alg_saldo
...
SELECT *
FROM docs.kassa_raamat('2021-07-21', current_date :: DATE, 132)
WHERE number = '1600'
