CREATE OR REPLACE FUNCTION palk.tsd_lisa_1b_(IN l_kpv1 date,IN l_kpv2 date,IN l_rekvid integer,IN l_kond integer)
    RETURNS TABLE(c_1300 character varying, c_1310 character varying, c_1320 character varying, c_1330 numeric, c_1340 integer, c_1350 integer, c_1360 character varying, pohjus_selg text, c_1370 numeric, c_1380 numeric, c_1390 numeric, c_1400 numeric, c_1410 numeric, c_1420 numeric, c_1430 numeric, c_1440 numeric, c_1450 numeric, c_1460 character varying, c_1470 numeric, c_1480 numeric, c_1500 numeric, c_1510 numeric, c_1520 numeric, c_1530 numeric, c_1540 numeric, c_1550 numeric)
    LANGUAGE 'sql'
    VOLATILE
    PARALLEL UNSAFE
    COST 100    ROWS 1000
...
SELECT *
FROM palk.tsd_lisa_1b_(make_date(2023,01,01)::date, make_date(2023,01,31)::date, 119, 0 :: INTEGER)
