DROP FUNCTION IF EXISTS docs.is_period_opened(INTEGER);

CREATE FUNCTION docs.is_period_opened(doc_id INTEGER)
    RETURNS BOOLEAN
    LANGUAGE plpgsql
AS
$$
...
GRANT EXECUTE ON FUNCTION docs.is_period_opened(doc_id INTEGER) TO arvestaja;
GRANT EXECUTE ON FUNCTION docs.is_period_opened(doc_id INTEGER) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION docs.is_period_opened(doc_id INTEGER) TO dbpeakasutaja;


/*
-- 1616801
select docs.is_period_opened(1616801)
 */