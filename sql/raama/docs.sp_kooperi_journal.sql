...
GRANT EXECUTE ON FUNCTION docs.sp_kooperi_journal(INTEGER, INTEGER) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION docs.sp_kooperi_journal(INTEGER, INTEGER) TO dbpeakasutaja;
