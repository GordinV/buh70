...
CREATE OR REPLACE FUNCTION rekl.sp_salvesta_luba(data JSON,
                                                 userid INTEGER,
                                                 user_rekvid INTEGER)
    RETURNS INTEGER AS
$BODY$
...
BEGIN
    ...
    THEN
        ...
        VALUES (doc_id, doc_asutusid, user_rekvid, doc_algkpv, doc_loppkpv, doc_number, doc_alus, doc_muud, doc_kord,
                doc_summa,
                CASE
                    WHEN is_import IS NOT NULL
                        THEN doc_staatus
                    ELSE 1 END) RETURNING id
                   INTO luba_id;
        ...
        LOOP
            ...
            FROM json_to_record(
                         json_object) AS x(id TEXT, nomid INTEGER, summa NUMERIC(14, 4), kogus NUMERIC(14, 4),
                                           maksumaar NUMERIC(12, 2), soodus_tyyp INTEGER, soodus NUMERIC(14, 2),
                                           staatus INTEGER, muud TEXT);
            ...
            THEN
                ...
                VALUES (luba_id, json_record.nomid, json_record.summa, coalesce(json_record.kogus, 1),
                        json_record.maksumaar,
                        json_record.soodus_tyyp, json_record.soodus, coalesce(json_record.staatus, 1),
...
/*
SELECT rekl.sp_salvesta_luba('{"id":0,"data":{"algkpv":"20200801","alus":"test","asutusid":29426,"bpm":null,"created":"18.09.2020 11:09:50","doc":"Reklmaamimaksu luba","docs_ids":"","doc_type_id":"LUBA","id":0,"intress":0,"jaak":0,"kord":"KUU","lastupdate":"18.09.2020 11:09:50","loppkpv":"20200831","muud":null,"number":"08\/2020-001","rekvid":null,"staatus":0,"status":"Eelnõu","summa":3,"volg":0,"gridData":[{"id":0,"kogus":1,"kood":"001","liik":"","maksumaar":9.60,"muud":"","nimetus":"","nomid":1918,"parentid":0,"soodus":0,"soodustyyp":"","soodus_tyyp":0,"staatus":0,"summa":3,"userid":0}]}}', 4862, 28);
