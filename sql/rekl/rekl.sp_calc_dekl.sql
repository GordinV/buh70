    ...
    */
    ...
    LOOP
        ...
        LOOP
            ...
            IF l_dekl_number > 5 AND v_luba.kord IN ('KVARTAL')
            THEN
                EXIT;
            END IF;
        ...
        IF v_luba.kord = 'KUU'
        THEN
            l_dekl_number = month(l_kpv);
        END IF;

        SELECT coalesce(l_toiming_id, 0) AS id,
               v_luba.asutusid,
...
/*
select * from rekl.luba where number = '08/2020-239'
select * from ou.userid where rekvid = 28 and kasutaja = 'vlad'

SELECT rekl.sp_calc_dekl(2269464,4862)
