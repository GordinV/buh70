DROP FUNCTION IF EXISTS rekl.sp_koosta_teatis( INTEGER, JSON );

CREATE FUNCTION rekl.sp_koosta_teatis(IN  user_id    INTEGER, IN params JSON, OUT result INTEGER,
...
GRANT EXECUTE ON FUNCTION rekl.sp_koosta_teatis(INTEGER, JSON) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION rekl.sp_koosta_teatis(INTEGER, JSON) TO dbpeakasutaja;

/*
select rekl.sp_koosta_teatis(1,'{"id":294325}'::json)
