DROP FUNCTION IF EXISTS lapsed.import_vanemad(JSONB, INTEGER, INTEGER);

CREATE OR REPLACE FUNCTION lapsed.import_vanemad(IN data JSONB,
                                                 IN user_id INTEGER,
...
GRANT EXECUTE ON FUNCTION lapsed.import_vanemad (JSONB, INTEGER, INTEGER) TO arvestaja;
