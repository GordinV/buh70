...
GRANT EXECUTE ON FUNCTION libs.sp_salvesta_ladu(JSON, INTEGER, INTEGER) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION libs.sp_salvesta_ladu(JSON, INTEGER, INTEGER) TO dbpeakasutaja;
