DROP FUNCTION IF EXISTS libs.sp_salvesta_ameti_klassif( JSON, INTEGER, INTEGER );

CREATE OR REPLACE FUNCTION libs.sp_salvesta_ameti_klassif(
    data        JSON,
    userid      INTEGER,
    user_rekvid INTEGER)
    RETURNS INTEGER AS
...
GRANT EXECUTE ON FUNCTION libs.sp_salvesta_ameti_klassif(JSON, INTEGER, INTEGER) TO dbkasutaja;
GRANT EXECUTE ON FUNCTION libs.sp_salvesta_ameti_klassif(JSON, INTEGER, INTEGER) TO dbpeakasutaja;
