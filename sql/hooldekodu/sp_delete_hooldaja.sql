DROP FUNCTION IF EXISTS hooldekodu.sp_delete_hooldaja(INTEGER, INTEGER);

CREATE OR REPLACE FUNCTION hooldekodu.sp_delete_hooldaja(IN userid INTEGER,
                                                         IN doc_id INTEGER,
...
GRANT EXECUTE ON FUNCTION hooldekodu.sp_delete_hooldaja(INTEGER, INTEGER) TO soametnik;
GRANT EXECUTE ON FUNCTION hooldekodu.sp_delete_hooldaja(INTEGER, INTEGER) TO hkametnik;
