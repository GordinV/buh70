...
BEGIN
  ...
  RAISE NOTICE 'sp_calc_arv l_tulud_kokku %, l_mvt_kokku %, l_isiku_mvt %, l_kasutatud_mvt %, l_alus_summa %', l_tulud_kokku, l_mvt_kokku, l_isiku_mvt, l_kasutatud_mvt, l_alus_summa;
